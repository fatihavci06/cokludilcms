            ...
            <div class="row gap-20 masonry pos-r">
              ...
              <div class="masonry-item col-md-12">
                <div class="bgc-white p-20 bd">
                  <h6 class="c-grey-900">Takım Ekle</h6>
                  <div class="mT-30">
                    @if(session('status'))
                    ...
                    @endif
                    <form method="post" action="{{route('takim.store')}}" enctype="multipart/form-data">
                      @csrf
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          ...
                          <input type="text" class="form-control" name="pozisyon" value="{{old('pozisyon')}}" >
                        </div>
                       </div>
