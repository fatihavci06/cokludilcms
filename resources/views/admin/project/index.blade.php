              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <h4 class="c-grey-900 mB-20">Projeler</h4>
        ...
        <tbody id="sortable">
          @foreach($data as $d)
            <tr id="project_{{$d->id}}">
                ...
                <td><a class="btn btn-primary" href="{{route('project.edit',$d->id)}}">Düzenle</a></td>
                <td><a  onclick="silmedenSor({{'"'.route('project.delete',$d->id).'"'}});return false" class="edit btn btn-danger btn-sm">Sil</a></td>
            </tr>
          @endforeach
  ...
  $( function() {
    $( "#sortable" ).sortable({
        ...
        update:function(){
         ...
         $.get("{{route('project.sortable')}}?",siralama,function(data,status){
            console.log(data);
         });
        }
    });
